...
import { Heart, Instagram, Mail, Phone, MapPin, Facebook, Youtube } from "lucide-react";
...
const Footer = () => {
      ...
      <Youtube className="h-5 w-5" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "About", "Services", "Gallery", "News", "Team", "Contact"].map((item) => (
                <li key={item}>
                  <button
  ...
  <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full">
    <p className="text-white/70 text-sm text-center w-full">
