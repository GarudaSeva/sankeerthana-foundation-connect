...
const Services = () => {
  const services = [
    ...
    {
      title: "Food Donation",
      description: "Regular food distribution programs at hospitals, orphanages, and on the streets, especially during COVID-19 and other times of crisis.",
      img: foodImg,
    },
    {
    ...
    },
    {
      ...
      description: "Bringing together senior citizens and children to promote understanding, emotional bonding and stronger communities.",
      img: communityImg,
    },
    {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="bg-white/90 backdrop-blur-lg border border-white/40 rounded-3xl hover:shadow-[0_15px_40px_rgba(0,0,0,0.18)] transition-all duration-300 hover:-translate-y-2 cursor-pointer"
              >
                <div className="p-4">
                  <img
                    src={service.img}
                ...
                <CardContent className="px-6 pb-6 pt-0">
                  ...
                  <p className="text-muted-foreground text-sm text-justify leading-relaxed mx-auto">
  {service.description}
</p>
                </CardContent>
              </Card>
